...
import { Book, Plus, Calendar, ChevronRight } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {workspaces.map((workspace) => (
          <Link
            ...
            className="group block bg-[#111114] border border-[#27272A] rounded-xl p-8 hover:border-[#3F3F46] hover:bg-[#18181B] transition-all duration-300 relative overflow-hidden"
          >
            ...
            <p className="text-xs text-[#71717A] font-medium leading-relaxed mb-8">
